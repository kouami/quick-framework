...
public class MyBatisConfig extends DBConfig {
	...
	public DataSource dataSource() {
        ...
        jdbcTemplate.execute("create table book(id int generated by default as identity (start with 1, increment by 1) not null, title varchar(50), author varchar(50), isbn varchar(50))");
    ...
    public SqlSessionFactoryBean sqlSessionFactory() throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.quick.entities");
